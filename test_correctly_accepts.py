...
assert check('int main(void){int a[5]; a[3] = 174; int *p = a + 3; return *p++;}' , 174)
...
assert check('struct A{int a; char c; char d; int b;}; int main(){ return sizeof(struct A);}' , 12)

assert check('int *f(int *p){return p;} int main(){int a[4]; a[0] = 1; f(a)[0]++; f(a)[1] = 172; return a[1]+a[0];}', 174)
assert check('struct A{char a; int b;}; int main(){struct A a; a.a = 74; return a.a;}' , 74)
assert check('struct A{int a; int b;}; int main(){struct A a; a.a = 174; return a.a;}' , 174)
assert check('struct A{int a; int b;}; int main(){struct A a; a.a = 174; return a.a;}' , 174)
assert check('int main(){int a; int *p; p = &a; *p = 2; int *q; q = &*p; *q = 174; return a;}' , 174)
assert check('int main(){int a; int *p; p = &a; *p = 2; int *q; q = &(*p); *q = 174; return a;}' , 174)
assert check('char foo(char *p){char a; return a;} int main(){char q; foo(&(q)); return 174;}' , 174)

assert check('int main(){/**/return 123;}' , 123)
assert check('int main(){/*u89g3wihu-@w3erolk*/ return (123);}' , 123)
assert check('int/*/* 0^[o;:._/-*/main(){return ((((123))));}' , 123)
assert check('int main(){int a[10]; a[5] = 173; int b; b = a[5]++; return a[5]*!(a[5]-b-1);}' , 174)
assert check('int main(){int a[1]; int *p; p = a; *p=2; return 174;}' , 174)
assert check('int main(){int a[1]; *(a+0)=2;return 174;}' , 174)
assert check('int x; int *y; int main(){x=3; int a[1]; *a=2; y=a; return x+*y+169;}' , 174)
assert check('int x; int main(){x=3; int *y; y=&x; return *y+171;}' , 174)
assert check('int a[1]; int main(){ *a=2;return 174;}' , 174)
assert check('int main(){int a[1][2];int *q;q = *a;return 174;}' , 174)
assert check('int main(){int a[1][2];int *q;q = *a; *q=174; return **a;}' , 174)
assert check('int main(){int a[86][2];int *q;q = *(a+1); *q=174; return **(a+1);}' , 174)
assert check('int main(){int a[5][6];int *q;q = *(a+1); *(2+q)=174; return *(*(1+a)+2);}' , 174)

assert check('int main(){int a[5][6];int *q;q = a[1]; 2[q]=174; return 1[a][2];}' , 174)
assert check('int main(){return 123;}' , 123)
assert check('int main(){return (123);}' , 123)
assert check('int main(){return ((((123))));}' , 123)
assert check('int main(){return 123+51;}' , 174)
assert check('int main(){return 123+56-5;}' , 174)
assert check('int main(){return 175-(4-3);}' , 174)
assert check('int main(){return 181-4-3;}' , 174)
assert check('int main(){return 6*(3+7)-5*1;}' , 55)

assert check('int main(){return +174;}' , 174)
assert check('int main(){return -(1-175);}' , 174)
assert check('int main(){23; 45+37; ((12-1)*75); return -(1-175);}' , 174)
assert check('int main(){23; 45+37; return -(1-175); ((12-1)*75);}' , 174)

assert check('int add_(int x, int y){4; return x+y;} int main(){3; return add_(87,87);}' , 174)
assert check('int main() { return (3 && 2 && 5) + 173; }' , 174)
assert check('int main() { return (3 && 2) + !(3 && 0) + !(0 && 3)+ !(0 && 0) + 170; }' , 174)
assert check('int main() { return (3 || 2 || 5) + 173; }' , 174)
assert check('int main() { return (3 || 2) + (3 || 0) + (0 || 3)+ !(0 || 0) + 170; }' , 174)
assert check('int main() {int a; a = 3; a += 5;  return a + 166; }' , 174)
assert check('int main() {int a; int b; a = 3; b = (a += 5);  return a + b + 158; }' , 174)
assert check('int main() {int a; int b; a = 3; b = 1; b *= (a += 5);  return a + b + 158; }' , 174)
assert check('int main() {int a; int b; a = 11; a -=5; a /= 2; b = 1; b *= (a += 5);  return a + b + 158; }' , 174)
assert check('int foo(){ return 2;} int main() {int a; int b; int c; a = 3;b = 5;c = 2;if(a) {b = foo();} else { }    return 172+b;}' , 174)
assert check('int foo(){ return 2;} int main() {int a; int b; int c; a = 3;b = 5;c = 2;if(a) {b = foo();}   return 172+b;}' , 174)
assert check('int foo(){ return 2;} int bar(){ return 7;} int main() {int a; int b; int c; a = 3;b = 5;c = 2;if(a) {b = foo();} else { c = bar();}    return 172+b;}' , 174)
assert check('int foo(){ return 2;} int bar(){ return 7;} int main() {int a; int b; int c; a = 0;b = 5;c = 2;if(a) {b = foo();} else { c = bar();}    return 162+b+c;}' , 174)
assert check('int foo(){ return 2;} int bar(){ return 7;} int main() {int a; int b; int c; a = 3;b = 5;c = 2;if(a) if(0) { b = foo(); } else {  c = bar(); }    return 162+b+c;}' , 174)
assert check('int foo(){ return 2;} int bar(){ return 7;} int main() {int a; int b; int c; a = 3;b = 5;c = 2;if(a) if(0)b=foo();else c = bar();return 162+b+c;}' , 174)
assert check('int main() {int a; a = 4; if(1){return 170+a; a = 7; }else{return 170-a; a = 9;} a = 5; return a;}' , 174)
assert check('int foo(){return 3;} int main() {int a; a = 0;while(a == foo()) {a = 3;}return 174;}' , 174)
assert check('int main(){int a; int b; a = 0; b = 0; while(a <= 10) {b += a; a += 1;}return b;}' , 55)
assert check('int main(){int a; int b; a =-3; b=-6; return a*b*10+a+b+3;}' , 174)
assert check('int main(){int a; int b; a=3; b=0; b+= a++; return !(b-3)+!(a-4)+172;}' , 174)

assert check('struct A {int a;};int main(){const struct A *a; return 174;}' , 174)
assert check('int main(void){int a = 5; return 174;}' , 174)
assert check('int main(void){int u = 0; for(int a = 0; a < 10; a++){ u += a; } return 174+u-45;}' , 174)
assert check('int main(void){int a = 5; int *p = &a; return 174;}' , 174)
assert check('int main(void){int a = 4; int *p = &a; *p += 170; return a;}' , 174)
assert check('int main(){int a; int *p = &a; *p = 2; int *q = &*p; *q = 174; return a;}' , 174)
assert check('int main(){int a; int *p = &a; *p = 2; int *q = &(*p); *q = 174; return a;}' , 174)
assert check('int main(){int x = 86;int *y = &x; return (*y) + x + 2;}' , 174)
assert check('int main(){int x = 86;int *y = &x; return (*y) + (*y) + 2;}' , 174)
assert check('int main(){int x = 86;int *y = &x;int **z = &y;return (*y) + (**z) + 2;}' , 174)
assert check('int main(){int x = 86;int *y = &x;int **z = &y;return*y+**z+2;}' , 174)

assert check('struct A{int a; int b;}; int main(){ struct A a; return 174;}' , 174)
assert check('struct A{int a; int b;}; int main(){ struct A a[10]; return 174;}' , 174)
assert check('struct A{int a; int b;};  struct A a[10]; int main(){return 174;}' , 174)
assert check('int printf();int a() {return 3;}int main() {int i; printf("%d %d", i, a()); return 0;}' , 0)
assert check('int foo(char *a, int b, int c){return 0;} int a(int N) {return 3;}int main() {int i; foo("%d %d", i, a(i)); return 0;}' , 0)
assert check('int printf();int a(int N) {return 3;}int main() {int i; printf("%d %d", i, a(i)); return 0;}' , 0)
assert check('int printf();int puts();int a(int N) {return 3;}int main() {int i; for (i = 1; i <= 12; i++) { printf("%d %d", i, a(i)); puts("");} return 0;}' , 0)
assert check('int printf();int puts();int A[200][200];int a(int row, int N) {return 3;}int main() {int i; for (i = 1; i <= 12; i++) { printf("%d %d", i, a(0, i)); puts("");} return 0;}' , 0)
assert check('int printf();int puts();int A[200][200];int dfs(int row, int N) { if (row == N) return 1; int ret;ret = 0; int col;for (col = 0; col < N; col++) { int ok; ok = 1; int i; for (i = 1; i < N; i++) { if (row - i >= 0 && col - i >= 0) { ok = ok && A[row - i][col - i] == 0; } if (row - i >= 0) { ok = ok && A[row - i][col] == 0; } if (row - i >= 0 && col + i < N) { ok = ok && A[row - i][col + i] == 0; } } if (ok) { A[row][col] = 1; ret += dfs(row + 1, N); A[row][col] = 0; } } return ret;}int main() {int i; for (i = 1; i < 12; i++) { printf("%d queen: %d", i, dfs(0, i)); puts("");} return 0;}' , 0)
assert check('char foo(){char a; return a;} int main(){foo(); return 174;}' , 174)
assert check('char foo(char *p){char a; return a;} int main(){char q; foo(&q); return 174;}' , 174)
assert check('char foo(char *p){char a; a = 5; return a;} int main(){char q; foo(&q); return 174;}' , 174)
assert check('int main(){char x[3]; x[0] = -1; x[1] = 2; int y; y = 4; return x[0] + y + 171;}' , 174)
assert check('char foo(char *p){*p = 5; char a;a = 3; return a;} int main(){char q; char r; r = foo(&q); return 172-r+q;}' , 174)
assert check('char a;char foo(char *p){*p = 5; a = 3; return a;} int main(){char q; char r; r = foo(&q); return 172-r+q;}' , 174)
assert check('int foo(char a){int d;d = 3;char c;c = a+d;return c;} int main(){char f;f=3;return foo(f)*4+150;}' , 174)
assert check('int foo(char a){int d;d = 3;char c;c = a+d;return c*4;} int main(){char f;f=3;return foo(f)+150;}' , 174)
assert check('int foo(char a, char b){return 23;} int main(){char f;f=3;return foo(f,4)+151;}' , 174)
assert check('int foo(char a, char b){return a*4+11;} int main(){char f;f=3;return foo(f,4)+151;}' , 174)
assert check('int foo(char a, char b){return a*4+12;} int main(){char f;f=3;return foo(f,4)+150;}' , 174)
assert check('int foo(char a, char b){return (a+3)*4;} int main(){char f;f=3;return foo(f,4)+150;}' , 174)
assert check('int foo(char a, char b){char c;c = a+3;return c*4;} int main(){char f;f=3;return foo(f,4)+150;}' , 174)
assert check('int foo(char a, char b){int d;d = 3;char c;c = a+d;return c*4;} int main(){char f;f=3;return foo(f,4)+150;}' , 174)
assert check('int foo(char a, char b){int d;d = 3;char c;c = a+d;return c*b;} int main(){char f;f=3;return foo(f,4)+150;}' , 174)
assert check('char foo() { char *x;x = "1ab"; return x[0]; }int main(){ char *y;y = "a2b"; int z;z = 12; char a;a = y[1]; return (a-foo())*z+162;}' , 174)
assert check('int printf();int main(){printf("%d %s", 1, "a");return 174;}' , 174)
assert check('int printf();int puts();int A[200][200];int main() {int i; for (i = 1; i <= 12; i++) { printf("%d %d", i, i); puts(""); } return 0;}' , 0)
assert check('int printf();int puts();int a(int b, int c) {return 3;}int main() {int i; for (i = 1; i <= 12; i++) { int j;j = a(0, i); printf("%d %d", i, j); puts("");} return 0;}' , 0)
...
assert check('int *foo(){return 0;} int main(){int *p = foo(); if (p == 0) {return 174;} else {return 1;} }' , 174)
assert check('int main(){int a[5];int *p = a;if (p == 0) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = 0;if (p == 0) {return 174;} else {return 1;}}' , 174)
assert check('int main(){int a[5];int *p = 0;if (p != 0) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = a;if (p != 0) {return 174;} else {return 1;}}' , 174)
assert check('int main(); int main(void){return 174;} int main(void);' , 174)
assert check('int main(){int a[5];int *p = a;int *q = a+3;if (p < q) {return 174;} else {return 1;}}' , 174)
assert check('int main(){int a[5];int *p = a;int *q = a+3;if (p > q) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = a;int *q = a+3;if (p <= q) {return 174;} else {return 1;}}' , 174)
assert check('int main(){int a[5];int *p = a;int *q = a+3;if (p >= q) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = a;int *q = a;if (p < q) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = a;int *q = a;if (p > q) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = a;int *q = a;if (p <= q) {return 174;} else {return 1;}}' , 174)
assert check('int main(){int a[5];int *p = a;int *q = a;if (p >= q) {return 174;} else {return 1;}}' , 174)
assert check('int main(){int a[5];int *p = a;int *q = a;if (p == q) {return 174;} else {return 1;}}' , 174)
assert check('int main(){int a[5];int *p = a;int *q = a;if (p != q) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = a;int *q = a+3;if (p == q) {return 174;} else {return 1;}}' , 1)
assert check('int main(){int a[5];int *p = a;int *q = a+3;if (p != q) {return 174;} else {return 1;}}' , 174)
assert check('int main(void){int a[5]; a[3] = 174; int *p = a; p += 3; return *p;}' , 174)

assert check('int main(void) {char a = 74; char *p = &a; return *p+100;} ' , 174)
assert check('struct A{char a; int b;}; int main(){struct A a; a.a = 74; struct A b; b = a; return b.a;}' , 74)
assert check('struct A{char a; int b;}; int main(){struct A a; a.a = 74; struct A b = a; return b.a;}' , 74)
assert check('struct A{int a; int b;}; int main(){struct A a; a.a = 174; struct A b = a; return b.a;}' , 174)
assert check('struct A{int a; int b;}; int main(){struct A a; a.a = 174; struct A b = a; return b.a;}' , 174)

assert check('struct A{int a;}; int main(){struct A arr[5]; void *p = arr; int *q = p; q[3] = 174; return arr[3].a;}' , 174)
assert check('int main(){int a[5]; if(a){return 174;} return 0;}' , 174)
assert check('int main(void){int p = 0; return (!p)*174; }' , 174)
assert check('int main(void){int *p = 0; return (!p)*174; }' , 174)
assert check('int main(void){int q; int *p = &q; return (1+!p)*174;}' , 174)
assert check('struct A{int a;}; struct A f(void) {struct A u; u.a = 174; return u;} int main(void){struct A u = f(); return u.a;}' , 174)

assert check('void f(int *p){*p = 174;} int main(void){ int a; f(&a); return a;}' , 174)
assert check('int main(){int *p; p = 0; if(p) {return 4; } return 174;}' , 174)
assert check('int main(){int *p; int a; p = &a; if(p) {return 4; } return 174;}' , 4)
assert check('int main(){int *p; int a; p = &a; return p && &p;}' , 1)
assert check('int main(){int *p; int a; p = &a; return p || &p;}' , 1)
assert check('int main(void){return 174;}' , 174)
assert check('int main(void){void *p; p = 0; p = p; return 174;}' , 174)
assert check('struct A{int a; int b;}; int main(){ struct A *p; void *q1; void *q2; q1 = p; q2 = p+1; char *r1; char *r2; r1 = q1; r2 = q2; return r2-r1;}' , 8)
assert check('void f(int *p){*p = 174; return;} int main(void){ int a; f(&a); return a;}' , 174)
assert check('int main(){int a; a = 3; { a = 174;} return a;}' , 174)
assert check('int main() {int *b; int a; a = 3; a += 5;  return a + 166; }' , 174)
assert check('int main() {int *******b; int a; a = 3; a += 5;  return a + 166; }' , 174)
assert check('int main() {int a; a = 174; int *b; b = &a; return a;}' , 174)
assert check('int main(){int x;x = 86;int *y;y = &x; return (*y) + x + 2;}' , 174)
assert check('int main(){int x;x = 86;int *y;y = &x; return (*y) + (*y) + 2;}' , 174)
assert check('int main(){int x;x = 86;int *y;y = &x;int **z;z = &y;return (*y) + (**z) + 2;}' , 174)
assert check('int main(){int x;x = 86;int *y;y = &x;int **z;z = &y;return*y+**z+2;}' , 174)
assert check('int main() {int x;int *y;x = 3;y = &x;*y = 174;return x;}' , 174)
assert check('int main() {int x;int *y;x = 3;y = &x;*y = 171;*y += 3;return x;}' , 174)
assert check('int main(){int x; int y; int *z; int*a; z=&x; a=&y; *z=*a=87; return(x+y);}' , 174)
assert check('int main(){int x; int *y; int **z; z = &y; *z = &x; *y = 174; return x;}' , 174)
assert check('int foo(int* p){return 3;} int main(){int x; return 174;}' , 174)
assert check('int foo(int* p){return *p;} int main(){int x; x = 174; return foo(&x);}' , 174)
assert check('int foo(int* p){*p = 172; return *p+2;} int main(){int x; return foo(&x);}' , 174)
assert check('int *foo(int *p){*p = 4;return p;} int main(){int x;int *y;y = foo(&x); *y+= 170;return x;}' , 174)
assert check('int *foo(int *p){*p = 4;return p;} int main(){int x;int y;*foo(&x) += 170;return x;}' , 174)
assert check('int *foo(int *p){*p = 4;return p;} int main(){int x;int y; int **z; *foo(&x) += 170;return x;}' , 174)
assert check('int main(){int a[2][3]; return 174;}' , 174)
assert check('int x; int *y; int main(){return 174;}' , 174)
assert check('int x; int *y; int main(){return x+174;}' , 174)
assert check('int x; int *y; int main(){x=3; int a; a=2; y=&a; return x+*y+169;}' , 174)

assert check('struct A {int k[15];}; int main(){struct A s; s.k[3] = 35; return s.k[3];}' , 35)
assert check('struct A {int a; int b; int c;}; int main(){struct A a[5]; return a + 3 - a;}' , 3)
assert check('struct A {int k[15];}; int main(){struct A a[5]; return a + 3 - a;}' , 3)

assert check('int main(){char a[456]; return a + 3 - a; }' , 3)
assert check('struct A {int k[15];}; int main(){struct A s; return 3;}' , 3)
assert check('struct A {int k[15]; int a;}; int main(){struct A s; s.a = 3; return s.a;}' , 3)
assert check('struct A {int k[15]; int a;}; int main(){return sizeof(struct A);}' , 64)
assert check('struct A {int k[15];}; int main(){struct A s; void *p = s.k; return 35;}' , 35)
assert check('struct A {int k[15];}; int main(){struct A s; int *p = s.k; return 35;}' , 35)

assert check('int main() {return 0;} //nfsjdgkssfdvc' , 0)
assert check('int main() { int *a; return sizeof a; }' , 8)
assert check('int main() { int *a; return sizeof (a+0); }' , 8)
assert check('int main() { int a[2][3]; return sizeof a; }' , 24)
assert check('int main() { int a[2][3]; return sizeof (a+0); }' , 8)
assert check('int main() { int a; return sizeof a; }' , 4)
assert check("int main() { return sizeof 'C'; }" , 4)
assert check("int main() { char a; return sizeof a; }" , 1)

assert check('int main() { int a; if (1) { a = 3; } else { a = 7; } return a; }' , 3)
assert check('void foo(int*p) {*p=3;} int main() { int a; if (0) { foo(&a); } else { a = 7; } return a; }' , 7)
assert check('void foo(int*p) {*p=7;} int main() { int a; if (0) { a = 3; } else { foo(&a); } return a; }' , 7)
